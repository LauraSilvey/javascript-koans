...
describe("About Applying What We Have Learnt", function() {
  ...
  it("given I'm allergic to nuts and hate mushrooms, it should find a pizza I can eat (functional)", function () {
      ...
      productsICanEat = _.filter(products, function(x) {return (!x.containsNuts && !_.any(x.ingredients, function (i) {return i === "mushrooms"}))});
  ...
  it("should count the ingredient occurrence (functional)", function () {
    ...
    var ingredientCount = _(products).chain()
                            ...
                            .flatten()
                            .reduce(function(count, x) {count[x] ? count[x] ++ : count[x] = 1; return count}, {})
                            .value();
